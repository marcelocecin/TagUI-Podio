...
def run_podio_tagui(self, args):
    if "param1" in args:
        tagui_cmd = 'tagui /home/rpa/tagui/API/podio'+args['script']+'.tag '+args['param1']+' -q -h'
    if "param1" in args and "param2" in args:
        tagui_cmd = 'tagui /home/rpa/tagui/API/podio'+args['script']+'.tag '+args['param1']+' '+args['param2']+' -q -h'
    else:
        tagui_cmd = 'tagui /home/rpa/tagui/API/podio'+args['script']+'.tag -q -h'
